...
/**
 * <b>Project Name Too Long</b> {@link Exception}.
 * <hr>
 *
...
@ResponseStatus(
        ...
        reason = ProjectConstants.AST_NAME_MAX)
public final class ProjectNameTooLong extends AProjectException {
     ...
     */
    public ProjectNameTooLong(final int iSize) {
        super(ProjectConstants.COD_NAME_MAX, MSG_PFX + iSize + MSG_SFX);
    }
